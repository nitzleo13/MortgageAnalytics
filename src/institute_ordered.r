...
View(tab)
tab_filtered12<-sqldf('SELECT  Respondent_Name_TS, share, As_of_Year from tab where As_of_Year="2012" Order By share DESC ')
tab_filtered13<-sqldf('SELECT  Respondent_Name_TS, share, As_of_Year from tab where As_of_Year="2013"Order By share DESC ')
tab_filtered14<-sqldf('SELECT  Respondent_Name_TS, share, As_of_Year from tab where As_of_Year="2014" Order By share DESC ')
